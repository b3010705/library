		...
		<div id="list-book" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="dateborrowed" title="${message(code: 'book.dateborrowed.label', default: 'Dateborrowed')}" />
					
						<g:sortableColumn property="isbn" title="${message(code: 'book.isbn.label', default: 'Isbn')}" />
					
						<g:sortableColumn property="returndate" title="${message(code: 'book.returndate.label', default: 'Returndate')}" />
