	...
	<body>
		...
		<div id="show-book" class="content scaffold-show" role="main">
			...
			<ol class="property-list book">
				...
				<li class="fieldcontain">
					<span id="dateborrowed-label" class="property-label"><g:message code="book.dateborrowed.label" default="Dateborrowed" /></span>
				...
				<li class="fieldcontain">
					<span id="returndate-label" class="property-label"><g:message code="book.returndate.label" default="Returndate" /></span>
